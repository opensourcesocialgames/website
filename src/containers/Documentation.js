          ...
          >
            ...
            {tabs.map((tab) => (
              ...
              <TabPanel value={value} index={tab.num}>
                  <Paper elevation={3}>
                    <h5 style={{color: "#023E8A", marginTop: 3, marginBottom: 3, fontStyle: "italic",}}>
                      {tab.name}
                    </h5>
                  </Paper>
                {tab.info}
      ...
      <Box> 
        <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}  >
          ...
          style={{
            ...
            Different Languages are called for across the
      ...
      <Box> 
        <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}  >
          ...
          style={{
            ...
            Resources used in the Development of our FrontEnds!
          </p>
          </Paper>
          <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}>
            <body>
      ...
      <Box> 
        <Paper elevation={3} sx={{py:1, px:2,}}  >
          ...
          style={{
            ...
            Resources used in to aid in Networking across the project!
          </p>
          </Paper>
          <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}>
            <body>
      ...
      <Box> 
        <Paper elevation={3} sx={{py:1, px:2,}}  >
          ...
          style={{
            ...
            Checkout out the technologies used to develop our Backend!
          </p>
          </Paper>
          <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}>
            <body>
      ...
      <Box> 
        <Paper elevation={3} sx={{py:1, px:2,}}  >
          ...
          style={{
            ...
            Learn how we keep track of all our information!
          </p>
          </Paper>
          <Paper elevation={3} sx={{py:1, px:2,my:1, mx:1}}>
            <body>
